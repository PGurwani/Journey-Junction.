...
export default function BasicModal() {
  ...
  return (
    <div>
      {!authenticated && ( // Conditionally render login button based on authentication state
        <Button onClick={handleOpen} style={buttonStyle}>
          Login
        </Button>
      )}
      {authenticated && ( // Conditionally render logout button based on authentication state
